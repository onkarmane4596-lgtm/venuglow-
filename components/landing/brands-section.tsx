              ...
              <div className="space-y-8 order-1 lg:order-2">
                <div>
                  ...
                  <div className="text-sm md:text-base font-light text-[#6B5A45] leading-relaxed space-y-4">
                    <p>
                      Authentic semi-precious stone articles designed for wellness, décor, and gifting. Sourced responsibly and crafted with care, our collection features amethyst, agate, and quartz masterpieces that balance aesthetic beauty with natural energy
                    </p>
                  </div>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20">
              <div className="space-y-8">
                <div>
                  ...
                  <div className="text-sm md:text-base font-light text-[#6B5A45] leading-relaxed space-y-4">
                    <p>
                      A refined fusion of contemporary and traditional imitation jewellery. From western minimalism to heritage classics, our designs offer affordable luxury and timeless elegance, perfect for everyday wear or festive occasions
                    </p>
                  </div>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20">
              <div className="space-y-8">
                <div>
                  ...
                  <div className="text-sm md:text-base font-light text-[#6B5A45] leading-relaxed space-y-4">
                    <p>
                      Functional luxury for the modern lifestyle. Our premium leather and non-leather accessories—including handbags, wallets, and belts—combine durability with sophisticated design, tailored for the discerning global professional
                    </p>
                  </div>
                </div>
